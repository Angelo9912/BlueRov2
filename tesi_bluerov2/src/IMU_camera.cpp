...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "imu_camera_publisher");

    // Create a handle to this process' node.
    ros::NodeHandle nh;

    // Create a publisher object.
    ros::Publisher pub = nh.advertise<tesi_bluerov2::Floats>("sensors/IMU_camera_topic", 1000);
    ...
    while (ros::ok())
    {
        ...
        std::vector<double> imu_data = {p_m, q_m, r_m, valid};
        msg.data = imu_data;
