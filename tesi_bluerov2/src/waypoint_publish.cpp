...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    ros::Publisher chatter_pub = n.advertise<tesi_bluerov2::Floats>("desired_state_topic", 1);
    double freq = 100;
    double dt = 1 / freq;
    ...
    while (ros::ok())
    {
        ...
        double y_d = 5.0;
        double z_d = 1.0;
        double psi_d = M_PI / 4.0;
        double x_dot_d = 0.5*cos(psi_d);
        double y_dot_d = 0.5*sin(psi_d);
        double z_dot_d = 0.0;
