...
void waypointCallback(const tesi_bluerov2::Floats_String::ConstPtr &msg) // CALLBACK che riceve i waypoint
{
...
int main(int argc, char **argv)
{
    ...
    ros::Publisher chatter_pub = n.advertise<tesi_bluerov2::Floats>("desired_state_topic", 1);         // publisher stato desiderato
